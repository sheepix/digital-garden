  ...
  fetch('/tags.json')
    ...
    .then(tagsData => {
      ...
      for (let i = 0; i < tagsArray.length; i++) {
        ...
        const slug = encodeURIComponent(tagText).toLowerCase().replace(/%20/g, '-');
        ...
        html += '<a href="#tag-' + slug + '" aria-label="Tag: ' + tagText + '" class="hover:text-primary transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none dark:focus-visible:ring-offset-stone-900 focus-visible:ring-offset-2">#' + tagText + '</a>';
        html += '</h2>';
