  ...
  fetch('/tags.json')
    ...
    .then(function(tagsData) {
      ...
      for (var i = 0; i < sortedTags.length; i++) {
        ...
        html += '<a href="/tags/#tag-' + encodeURIComponent(tag) + '" class="inline-block px-2 py-1 rounded-full bg-stone-100 dark:bg-stone-800 hover:bg-primary/10 hover:text-primary transition-colors" style="font-size: ' + getTagSize(count, maxCount) + '">#' + tag + '</a>';
      }
      html += '</div>';
