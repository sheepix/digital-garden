  ...
  fetch('/tags.json')
    ...
    .then(function(tagsData) {
      ...
      for (var i = 0; i < sortedTags.length; i++) {
        ...
        html += '<a href="/tags/#tag-' + encodeURIComponent(tag) + '" aria-label="Tag: ' + tag + '" class="inline-block px-2 py-1 rounded-full bg-stone-100 dark:bg-stone-800 hover:bg-primary/10 hover:text-primary transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none dark:focus-visible:ring-offset-stone-900" style="font-size: ' + getTagSize(count, maxCount) + '">#' + tag + '</a>';
      }
      html += '</div>';
