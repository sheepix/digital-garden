...
def test_tags_deep_link(page: Page):
  ...
  # Check if tags.json is loaded. The JS fetches '/tags.json'.
  # In file:// protocol, fetch('/tags.json') might fail or look for file:///tags.json which is wrong.
  # We need to see if there are any console errors.
