...
def test_tags_deep_link(page: Page):
  ...
  # Inject the tag cloud logic directly to verify it works if the file was missing
  # This mimics what tag-cloud.js does but ensuring it runs in this context
  page.evaluate('''
    fetch('/tags.json')
    ...
    .then(function(tagsData) {
      ...
      for (var i = 0; i < sortedTags.length; i++) {
        ...
        html += '<a href="/tags/#tag-' + tag + '" class="tag-link">#' + tag + '</a>';
      }
      html += '</div>';
