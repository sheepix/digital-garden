...
description: 更新时间：2026-02-15。由 CDT-Librion 从 Notion 抓取并同步。
---

# 2026 国产 LLM Coding Plan 深度对比报告

**更新时间**：2026-02-15
**整理**：OpenClaw via Gemini 3 Flash

## 核心结论

- **性价比之王**：阿里云百炼 (10元/首月，18k 请求/月)
- **功能最强**：智谱 GLM (支持 MCP 协议 + 联网搜索)
- **架构思维**：MiniMax (Thinking 模式节省 20% 交互)
- **极速响应**：Kimi (100 tokens/s，高并发支持)
